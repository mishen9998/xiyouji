...
public class RoomService {
    ...
    public RoomDTO createRoom(String hostUserId, String hostUsername) {
        return lockService.executeWithLock("xiyouji:lock:room:create", 5, () -> {
    ...
    public void leaveRoom(String code, String userId, long expectedVersion) {
        lockService.executeWithLock(RoomLockKeys.forRoom(code), 5, () -> {
            Room room = getRoomOrThrow(code);
            checkVersion(code, room, expectedVersion);
    ...
    public Map<String, Object> handleEvent(String code, String userId,
                                           ...
                                           long expectedVersion) {
        return lockService.executeWithLock(RoomLockKeys.forRoom(code), 5,
                () -> handleEventUnderLock(code, userId, action, cardId, cardIndex, expectedVersion));
    }

    private Map<String, Object> handleEventUnderLock(String code, String userId,
                                                      String action, Long cardId, Integer cardIndex,
                                                      long expectedVersion) {
        Room room = getRoomOrThrow(code);
        checkVersion(code, room, expectedVersion);
    ...
    private void checkVersion(String code, Room room, long expectedVersion) {
