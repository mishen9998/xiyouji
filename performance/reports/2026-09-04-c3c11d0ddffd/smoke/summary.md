...
| --- | ---: |
| 完成迭代 | 1 |
| 实际迭代速率 | 0.18 iterations/s |
| HTTP 请求速率 | 2.47 req/s |
| 丢弃迭代 | 0 |
| 完整业务链路成功率 | 100.00% |
| 房间清理成功率 | 100.00% |
| 跨实例不一致 | 0.00%（0 次） |
...
| HTTP 429 | 0 |
| HTTP 5xx | 0 |
| 业务链路耗时 P95 | 5567.00 ms |
| HTTP 请求耗时 P95 | 1348.34 ms |
| HTTP 请求失败率 | 0.00% |
...
| 指标 | 条件 | 结果 |
| --- | --- | --- |
| `business_cleanup_success` | `rate>=1` | PASS |
| `business_flow_success` | `rate>=1` | PASS |
| `business_step_success` | `rate>=1` | PASS |
