...
| --- | ---: |
| 完成迭代 | 2141 |
| 实际迭代速率 | 11.47 iterations/s |
| HTTP 请求速率 | 150.46 req/s |
| 丢弃迭代 | 20 |
| 完整业务链路成功率 | 91.97% |
| 房间清理成功率 | 100.00% |
| 跨实例不一致 | 0.00%（0 次） |
...
| HTTP 429 | 0 |
| HTTP 5xx | 172 |
| 业务链路耗时 P95 | 7596.00 ms |
| HTTP 请求耗时 P95 | 894.90 ms |
| HTTP 请求失败率 | 0.61% |
